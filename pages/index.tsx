...
export default function PrimarySearchAppBar() {
  ...
  return (
    ...
    >
      <Box sx={{ overflow: "auto" ,py:2,bgcolor: "#FF0" }}>
        <List >
          {data &&
            data.menu.map((menu: any, index: number) => (
              <ListItem  key={menu} disablePadding  onClick={() => console.log(menu)}>
                <ListItemButton >
                  <ListItemIcon >
